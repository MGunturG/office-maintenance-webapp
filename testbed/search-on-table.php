...
<head>
	...
	<title>test search on table</title>
...
<body>
    ...
    <button id="tombol" class="btn btn-outline-primary btn-lg btn-block">BasicExample</button>

    <!--  -->
    <label>select city</label>
	<select id="js-example-basic-multiple" class="js-example-basic-multiple" name="states[]" multiple="multiple">
