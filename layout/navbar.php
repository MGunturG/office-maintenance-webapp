            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="dropdown">
                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="user-menu d-flex">
                            <div class="user-name text-end me-3">
                                <h6 class="mb-0 text-gray-600"><?php echo ucwords(htmlspecialchars($_SESSION['user_uname'])); ?></h6>
                                <p class="mb-0 text-sm text-gray-600"><?php echo ucwords("Role: " . htmlspecialchars($_SESSION['user_role'])); ?></p>
                            </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                        <li>
                            <h6 class="dropdown-header">Hello, <?php echo ucwords(htmlspecialchars($_SESSION['user_uname'])); ?></h6>
                        </li>
                        ...
                        <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>/function/logout-function.php"><i
